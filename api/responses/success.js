...
module.exports = function sendSuccess (data) {
    ...
    let successObj = {};
    if(data.errorReason){
      successObj.status = 'fail';
      successObj.errorData = {};
      successObj.errorData = data;
    }else{
      successObj.status = 'success';
      if(data.msg && data.data){
        successObj.msg = data.msg;  
        successObj.data = data.data;
      }else if(data.msg && !data.data){
        successObj.msg = data.msg;  
      }else if(data.page && data.data){
        successObj.page = data.page; 
        successObj.data = data.data;
      }else if(data.data && data.user){
        successObj.user = data.user; 
        successObj.data = data.data;
      }else{
